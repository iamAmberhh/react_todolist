    ...
    <div className="container signUpPage vhContainer">
        ...
        <div>
            <form className="formControls" action="index.html">
                ...
                <input className="formControls_input" type="text" name="name" id="name" placeholder="請輸入您的暱稱" value={nickname} onChange={(e)=> setNickname(e.target.value)}/>
                ...
                <input className="formControls_input" type="password" name="pwd" id="pwdCheck" placeholder="請再次輸入密碼" required value={passwordCheck} onChange={(e)=> setPasswordCheck(e.target.value)}/>
